...
#---------------------------------------------------------------------------
# Word class representing one single word and its formatting info.
...
#---------------------------------------------------------------------------
# Format state class for formatting a series of words.
...
class FormatState(object):
    ...
    def __init__(self, cap=normal, cap_mode=normal, spacing=no,
                 spacing_mode=normal, between=False):
